...
<?php foreach ($comments as $comment) :?>
		<tr class="<?php 
			...
			<td>
				<ul>
					<li><button><a href="index.php?action=readComment&id=<?= htmlspecialchars($comment->getId()) ?>&post_id=<?= htmlspecialchars($comment->getPost_id()) ?>">Lire</a></button></li>
					<li><button><a href="index.php?action=modifyComment&id=<?= htmlspecialchars($comment->getId()) ?>&post_id=<?= htmlspecialchars($comment->getPost_id()) ?>">Modifier</a></button></li>
					<li><button><a href="index.php?action=cancelComment&id=<?= htmlspecialchars($comment->getId()) ?>">Supprimer</a></button></li>	
				</ul>
			</td>
		</tr>
<?php endforeach; ?>
