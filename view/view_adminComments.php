					...
					<tbody>
						<?php foreach ($comments as $comment) :?>
								<tr class="<?php if($comment->getIs_flagged()){ echo 'flagged'; };?>">
									<td data-title="Id commentaire/Id article" class="resp min"><?= htmlspecialchars($comment->getId()) ?> / <?=  htmlspecialchars($comment->getPost_id()) ?></td></td>
									...
									<td data-title="Date de création" class="resp"><?= htmlspecialchars ($comment->getFormatted_comment_date()) ?></td>
